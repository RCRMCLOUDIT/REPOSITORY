<%-- 
    Document   : ListadoMesasAct
    Created on : 11-08-2017, 03:10:13 PM
...
<html>
    <head>
        ...
        <title>Mesas Activas</title>
    </head>
    <%@include file="../commons/Menu.jsp" %>
    <body>
        <div id="EncabezadoPagina" style="background-color: #4682B4;">
            <center>
                <h1 style="color: #FFFFFF; text-align: center;">Lista de Mesas Activas</h1>                
            </center>
        </div>
        <section id="lista" class="container">
            <div class="row" id="ListaMesasActivas">
                <div  class="col-sm-8">
                                ...
                                <tbody>
                                    <%
                                        try {
                                            ...
                                            conn.Conectar();
                                            String consulta = "SELECT * FROM `mesa` WHERE Activo='SI'";
                                            ResultSet rs = null;
