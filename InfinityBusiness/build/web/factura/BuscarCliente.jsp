...
<html>
    ...
    <% //RECUPERO LA VARIABLE DE LA BUSQEDA DEL JSP DE LISTADO
        ...
        String quien;
        quien = request.getParameter("QuienLlama");
    %>
    <body>
                                        ...
                                        try {
                                            ...
                                            while (rs.next()) {
                                                ...
                                                out.println("<TD>"
                                                        ...
                                                        + "</TD>");
                                                if (quien.equals("ListadoCliente")) {
                                                    out.println("<TD>"
                                                            + "<a href='UpdateCliente.jsp?idCli=" + rs.getInt(1) + "' class='btn btn-primary'>Editar ó Ver</a>"
                                                            + "</TD>");
                                                } else if(quien.equals("OrdenVenta")) {
                                                    out.println("<TD>"
                                                            + "<a href='BuscarOrdenVenta.jsp?idCli=" + rs.getInt(1) + "' class='btn btn-primary'>Seleccionar</a>"
                                                            + "</TD>");
                                                }else {
                                                    out.println("<TD>"
                                                            + "<a href='AddFacturaManual.jsp?idCli=" + rs.getInt(1) + "' class='btn btn-primary'>Seleccionar</a>"
                                                            + "</TD>");
                                                }
