                            ...
                            try {
                                ...
                                while (rs.next()) {
                                    ...
                                    out.println("<TD style='display:none;'>"
                                            + "<form id='FormEstadoCuenta' role='form' action='../ServletFactura'"
                                ...
                                out.println("<TD>"
                                        + "<input type='text' class='form-control' style='width: 100px' id='SubTotal' name='form-SubTotal' readonly value='" + SubTotal + "'>"
                                        + "</TD>");
                                out.println("</TR>");
                                ...
                                out.println("<TD>"
                                        + "<input type='text' class='form-control' style='width: 100px' id='Iva' name='form-Iva' readonly value='" + Impuesto + "'>"
                                        + "</TD>");
                                out.println("</TR>");
                                ...
                                out.println("<TD>"
                                        + "<input type='text' class='form-control bg-success' style='width: 100px' id='Total' name='form-Total' readonly value='" + Total + "'>"
                                        + "</TD>");
                                out.println("</TR>");
                                ...
                                out.println("<TD>"
                                        + "<input type='text' class='form-control' style='width: 60px' id='form-idMesa' name='form-idMesa' value='" + idMesa + "' hidden='true'>"
                                        + "</TD>");
