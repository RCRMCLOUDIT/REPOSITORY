...
public class ServletProductoUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            datos.UpdateProducto(IdProducto, CodCatalogo, CodigoEAN, CodigoSKU, CodigoUPC, NombreProducto, Descripcion, CostoCompra, Precio1, Precio2, Precio3, Precio4, Descuento, Iva, StockMin, StockMax, Foto);
