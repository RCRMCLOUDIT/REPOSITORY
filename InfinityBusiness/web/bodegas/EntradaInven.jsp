<%-- 
    Document   : EntradaInven
    Created on : 07-28-2017, 02:44:11 AM
...
<html>
    ...
    <%--VENTANA MODAL PARA AGREGAR UNA NUEVA ENTRADA AL INVENTARIO --%>
<center>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="FormEntrada" role="form" action="ServletMovimientoInventario" method="POST" class="form-control">
                        ...
                        <div class="form-control">
                            <label for="AddCosto">Nuevo Costo</label>
