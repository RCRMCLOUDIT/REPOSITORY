<%-- 
    Document   : ListaReservaHotel
    Created on : 03-20-2018, 02:14:55 PM
...
<html>
    ...
    <body>
        <div id="EncabezadoPagina" style="background-color: #4682B4;">
            <center>
                <h1 style="color: #FFFFFF; text-align: center;">Listado de Reservas Realizadas</h1>                
            </center>
        </div>
                        ...
                        <div id="BuscarCliente">
                            <form id="FormBuscarCliente" role="form" action="BuscarReserva.jsp">
                                <div class="input-group">
                                    ...
                                    <a href="../reserva/ReservaHabitacion.jsp" class="btn btn-primary">Nueva Reserva</a>
                                </div>
                            </form>
                        </div>
                                ...
                                <tbody style="background-color: #C7C6C6;">
                                    <% // declarando y creando objetos globales 
                                        ...
                                        try {
                                            ...
                                            pst = conn.conexion.prepareStatement("SELECT IdReservHab, NombreCliente, Adultos, Niños, FechaIN, FechaOUT  FROM `reservahabitacion` ORDER BY FechaIN ASC");
                                            rs = pst.executeQuery();
                                            ...
                                            while (rs.next()) {
                                                ...
                                                out.println("<TD style='color: #000000;'>" + rs.getInt(4) + "</TD>");
