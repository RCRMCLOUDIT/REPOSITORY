...
<TITLE>Crear Programacion</TITLE>
<link rel="stylesheet" href="../../ERP_COMMON/Master.css" type="text/css">
</HEAD> 
<BODY onload="javascript: document.myForm.descrp.focus()">
<%! 
 static final String title = "Crear Programacion"; 
%>
...
<FORM method="post" name="myForm" action="<%=contextRoot%>/erp/payrollnic/confobjects/prcalens.jsp">
<INPUT type="hidden" name="action" id="action" value="ADDPRGH">
...
<TABLE width="600" cellpadding="1" cellspacing="1" class="Border">
    <TR>
      <TD colspan="2" class="tableheader">Crear Programacion</TD>
    </TR>   
    <TR class="pcrinfo">
    ...
    <TR class="pcrinfo1">
      ...
      <TD colspan="3">
		<INPUT type="hidden" name="creatById" id="creatById" value="<%=creatById%>">
 		<INPUT type="text" class="text"	size="20" maxlength="40" name="creatByNm" id="creatByNm" value="<%=creatByNm%>" onchange="this.form.creatById.value='';" onkeypress='if(isEnterPressed()) creatBy_search(myForm, "EMP","<%=contextRoot%>");' autocomplete="off" class="search search-icon">
		<INPUT type="button" class="hidden-btn name="searchEmp" value=" v " onclick='creatBy_search(myForm,"EMP","<%= contextRoot %>");'>      
      </TD> 
     </TR> 
    <TR class="pcrinfo">
      ...
      <TD colspan="3">
		<INPUT type="hidden" name="checkById" id="checkById" value="<%=checkById%>">
 		<INPUT type="text" class="text"	size="20" maxlength="40" name="checkByNm" id="checkByNm" value="<%=checkByNm%>" onchange="this.form.checkById.value='';" onkeypress='if(isEnterPressed()) checkBy_search(myForm, "EMP","<%=contextRoot%>");' autocomplete="off" class="search search-icon">
		<INPUT type="button" class="hidden-btn name="searchEmp" value=" v " onclick='checkBy_search(myForm,"EMP","<%= contextRoot %>");'>      
      </TD> 
     </TR>      
    <TR class="pcrinfo1">
      ...
      <TD colspan="3">
		<INPUT type="hidden" name="autById" id="autById" value="<%=autById%>">
 		<INPUT type="text" class="text"	size="20" maxlength="40" name="autByNm" id="autByNm" value="<%=autByNm%>" onchange="this.form.autById.value='';" onkeypress='if(isEnterPressed()) autBy_search(myForm, "EMP","<%=contextRoot%>");' autocomplete="off" class="search search-icon">
		<INPUT type="button" class="hidden-btn name="searchEmp" value=" v " onclick='autBy_search(myForm,"EMP","<%= contextRoot %>");'>      
      </TD> 
     </TR>   
</TABLE>
<TABLE width="600">
...
<INPUT type="button" name="Cancel" value="<%=rb.getString("B00010")%>" class="button" onclick="window.location = '<%=contextRoot%>/erp/payrollnic/confobjects/programlist.jsp';">
</TD>
</TR>
</TABLE>
</FORM>
