...
int i = 0;
 ...
 String link1 = baseLink + "wrkfixedincomes.jsp?startIndex=" + startIndex + "&conceptId=";
...
<TABLE width="750" cellpadding="0" cellspacing="1" class="Border" border="0">
    <TR class="tableheader">
    	<TD colspan="2">Trabajar con Percepciones Fijas</TD>
    </TR>
    <TR class="tableheader">
      <TD>Nombre</TD>
      <TD>Monto</TD>      
...
<TABLE border="0" width="750" cellspacing="0" cellpadding="0">
    <TR><TD width="30%" height="30">
		<FORM name="Add" method="post" action="<%=contextRoot%>/erp/payrollnic/mainpayroll/wrkfixedincomespre.jsp">
