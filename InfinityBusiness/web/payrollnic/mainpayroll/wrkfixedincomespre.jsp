...
<FORM method="post" name="myForm" action="<%=contextRoot%>/erp/payrollnic/mainpayroll/wrkfixedincomes.jsp">
...
<TABLE width="600" cellpadding="1" cellspacing="1" class="Border">
    <TR>
      <TD colspan="2" class="tableheader">Trabajar con Percepciones Fijas</TD>
    </TR>     
    <TR class="pcrinfo">
      <TD class="label"><SPAN class="textRed">*</SPAN>Percepcion Fija</TD>
      <TD>
...
<INPUT type="button" name="Cancel" value="<%=rb.getString("B00010")%>" class="button" onclick="window.location = '<%=contextRoot%>/erp/payrollnic/mainpayroll/wrkfixedincomeslist.jsp?payrollId=<%=payrollId%>';">
</TD>
</TR>
</TABLE>
</FORM>
