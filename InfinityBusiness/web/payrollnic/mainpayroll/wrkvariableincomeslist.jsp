...
<%! 
 ...
 static final int INCOMES_CUR = 1;
...
int i = 0;
 ...
 String link1 = baseLink + "wrkvariableincomes.jsp?startIndex=" + startIndex + "&conceptId=";
 
 listDBBean.execute(); 

 int numOfRows = listDBBean.getRowsInResult(INCOMES_CUR);
%>
<TABLE width="750" cellpadding="0" cellspacing="1" class="Border" border="0">
    <TR class="tableheader">
    	<TD colspan="2">Trabajar con Percepciones Variables</TD>
    </TR>
    <TR class="tableheader">
      <TD>Nombre</TD>
      <TD>Monto</TD>      
...
<%
 ...
 if (listDBBean.RowCountResult(INCOMES_CUR)==0) 
 {
%>
	<TR>
...
<TABLE border="0" width="750" cellspacing="0" cellpadding="0">
    <TR><TD width="30%" height="30">
		<FORM name="Add" method="post" action="<%=contextRoot%>/erp/payrollnic/mainpayroll/wrkvariableincomespre.jsp">
