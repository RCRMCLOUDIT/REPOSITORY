...
<FORM method="post" name="myForm" action="<%=contextRoot%>/erp/payrollnic/mainpayroll/wrkvariableincomes.jsp">
...
<TABLE width="600" cellpadding="1" cellspacing="1" class="Border">
    <TR>
      <TD colspan="2" class="tableheader">Trabajar con Percepciones Variables</TD>
    </TR>     
    <TR class="pcrinfo">
      <TD class="label"><SPAN class="textRed">*</SPAN>Percepcion Variable</TD>
      <TD>
...
<INPUT type="button" name="Cancel" value="<%=rb.getString("B00010")%>" class="button" onclick="window.location = '<%=contextRoot%>/erp/payrollnic/mainpayroll/wrkvariableincomeslist.jsp?payrollId=<%=payrollId%>';">
</TD>
</TR>
</TABLE>
</FORM>
