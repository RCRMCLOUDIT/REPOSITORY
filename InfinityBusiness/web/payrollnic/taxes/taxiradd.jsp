...
<TITLE>Agregar Detalle IR</TITLE>
<link rel="stylesheet" href="../../ERP_COMMON/Master.css" type="text/css">
</HEAD> 
<BODY onload="javascript: document.myForm.minAmt.focus()">
<%! 
 static final String title = "Agregar Detalle IR"; 
%>
 ...
 *******************************************************************************/
 String sqlString = "{CALL "+ DBLibConstants.UPLIB + "_OBJ.PRTAXIRS('" + 
 					companyID + "',0,0," + taxId + ",0,0,0,0,0,'','','IRNEW',?,?)}"; 
...
<INPUT type="hidden" name="action" id="action" value="IRADD">
...
<TABLE width="600" cellpadding="1" cellspacing="1" class="Border">
    <TR class="tableheader">
    	<TD colspan="2">Agregar Detalle IR</TD>
    </TR>
    <TR class="pcrinfo">
