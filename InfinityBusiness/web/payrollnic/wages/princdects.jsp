 ...
 *******************************************************************************/
 ...
 String isIncome 	= request.getParameter("isIncome")==null?"Y":request.getParameter("isIncome"); 
 String isDeduction = request.getParameter("isDeduction")==null?"N":request.getParameter("isDeduction"); 
 String status	 	= request.getParameter("status")==null?"AC":request.getParameter("status");   
 ...
 String comINC		= request.getParameter("comINC")==null?"":request.getParameter("comINC");
...
System.out.println("ErrMsg :" + errMsg);
 ...
 if(flag.equals("S")){
    //call list page
    response.sendRedirect(request.getContextPath() + "/erp/payrollnic/wages/wagelist.jsp");
 }
