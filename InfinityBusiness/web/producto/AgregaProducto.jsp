<%-- 
    ...
    Created on : 03-26-2018, 03:52:02 PM
            ...
            <form id="FormProducto" name="FormProducto" role="form" action="../ServletProductoAdd" method="POST" class="form-control">
                <div id="tab-1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control col-sm-4" name="NombreProducto" id="NombreProducto" required="true" size="50" autocomplete="off" placeholder="Ingrese el nombre del Producto...">
                    </div>
                    <div class="input-group">
                ...
                <div id="tab-4">
                    <div class="input-group">
                        ...
                        <input type="number" step="any" class="form-control col-sm-4" id="CostoCompra" name="CostoCompra" min="0" value="0.00" required="true" placeholder="Costo Compra..." style="text-align: center">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon col-sm-2"><strong>Precio Venta 1</strong></span>                        
                        <input type="number" step="any" class="form-control col-sm-4" id="Precio1" name="Precio1" min="0" value="0.00" required="true" placeholder="Precio Venta..." style="text-align: center">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon col-sm-2"><strong>Precio Venta 2</strong></span>                        
                        <input type="number" step="any" class="form-control col-sm-4" id="Precio2" name="Precio2" min="0" value="0.00" placeholder="Precio Venta..." style="text-align: center">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon col-sm-2"><strong>Precio Venta 3</strong></span>                        
                        <input type="number" step="any" class="form-control col-sm-4" id="Precio3" name="Precio3" min="0" value="0.00" placeholder="Precio Venta..." style="text-align: center">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon col-sm-2"><strong>Precio Venta 4</strong></span>                        
                        <input type="number" step="any" class="form-control col-sm-4" id="Precio4" name="Precio4" min="0" value="0.00" placeholder="Precio Venta..." style="text-align: center">
                    </div>                    
                </div>
                <div id="tab-5">
                    <div class="input-group">
